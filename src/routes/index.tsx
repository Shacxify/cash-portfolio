...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Cash Johnson - AI Architect" },
      {
        name: "description",
        content:
          "Cash Johnson is an AI Architect based in Silicon Valley, specializing in sales development and data analytics across operations, partnerships, and go-to-market.",
      },
      { property: "og:title", content: "Cash Johnson - AI Architect" },
      {
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Cash Johnson - AI Architect",
          mainEntity: {
            "@type": "Person",
            ...
            description:
              "Cash Johnson is an AI Architect based in Silicon Valley, specializing in sales development and data analytics at the intersection of enterprise operations, partnerships, and go-to-market strategy.",
            address: {
              "@type": "PostalAddress",
