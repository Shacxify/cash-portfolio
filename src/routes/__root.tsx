    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Personal portfolio of Cash Johnson, an AI Solutions Architect based in Silicon Valley - professional experience, featured projects, and contact information.",
